<template>
  <article>
    ...
    <p>
      ...
      приложение, тъй като предварителните заявки също заемат определено време.
    </p>
    <br />
    <h3>Прости (simple)</h3>
    <p>
    ...
    <ul style="line-height: 35px">
      ...
      <li>Заявката не носи auth token/информация за оторизация</li>
    </ul>
    <br />
    ...
    <p>
      ...
      <code>OPTIONS</code> метода. Това повикване се прави с цел установяване на
      точните CORS възможности на сървъра, което от своя страна се използва за
      определяне дали предвиденият CORS протокол е разбран или не. Ако
      резултатът от извикването на <code>OPTIONS</code> диктува, че заявката не
      може да бъде направена, действителната заявка към сървъра няма да бъде
      изпълнена.
    </p>
    <Figure
