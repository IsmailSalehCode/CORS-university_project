<template>
  <article>
    ...
    <p>
      ...
      , което чете HTML-a и броя снимки на подадения URL в полето „Target URL“.
      Тук сме подали URL към уеб-галерия, съдържаща 4 снимки и хоствана на порт
      3000. Тъй като в сървъра на localhost:3000 е подходящо конфигуриран CORS
      (фиг.
